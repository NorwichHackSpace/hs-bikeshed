  ...
  if (!project) {
    return (
      <Box>
        ...
        <Button startIcon={<ArrowBackIcon />} onClick={() => router.push('/members/projects')} sx={{ mt: 2 }}>
          Back to Projects
        </Button>
      </Box>
    )
  ...
  return (
    <Box>
      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 4 }}>
        <IconButton onClick={() => router.push('/members/projects')}>
          <ArrowBackIcon />
        </IconButton>
        <Box sx={{ flexGrow: 1 }}>
